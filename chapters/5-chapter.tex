...
\begin{verbatim}
<classe> <x centro> <y centro> <largura> <altura> <x ponto 1> <y ponto 1> <visibilidade ponto 1> ... <x ponto n> <y ponto n> <visibilidade ponto n>
\end{verbatim}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/training_curves_br.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{images/training_curves_me.png}
