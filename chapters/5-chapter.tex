...
Sendo que $c_l$, $c_r$, $c_t$ e $c_b$ são a quantidade de pixels a cortar na esquerda, direita, topo e parte de baixo da image, respectivamente. Esses valores são diferentes para placas do tipo Brasil e Mercosul, como discutido no capítulo 4.
