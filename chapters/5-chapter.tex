...
\subsection{Download do sistema operacional no computador e gravação no cartão SD}

A documentação do dispositivo Rock 3A inclui \textit{links} onde é possível fazer \textit{download} de algumas opções de imagens de sistemas operacionais que podem ser usados no Rock 3A. Essas imagens são arquivos que contém todo o conteúdo necessário para a instalação do sistema operacional no dispositivo.
...
\subsection{Habilitação da NPU e instalação das bibliotecas necessárias}
...
\subsection{Download do código, modelos e dados de teste para o dispositivo}
...
\begin{table}[H]
    \centering
    \caption{Acurácia por configuração de teste}
    \label{tab:acuracia}
    \begin{tabular}{llccc}
        \hline
        \textbf{Hardware} & \textbf{Pipeline} & \textbf{Acertos} & \textbf{Erros} & \textbf{Acurácia} \\
        \hline
...
\begin{table}[H]
    \centering
    \caption{Tempos médios de inferência por etapa (ms)}
    \label{tab:tempos}
    \begin{tabular}{llcccc}
        \hline
        \textbf{Hardware} & \textbf{Pipeline} & \textbf{Detecção} & \textbf{Extração} & \textbf{Leitura} & \textbf{Total} \\
        \hline
...
\begin{table}[H]
    \centering
    \caption{Comparativo geral entre configurações de teste}
    \label{tab:comparativo}
    \begin{tabular}{llcc}
        \hline
        \textbf{Hardware} & \textbf{Pipeline} & \textbf{Acurácia} & \textbf{Total (ms)} \\
        \hline
