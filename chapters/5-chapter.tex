...
As figuras \ref{fig:arquitetura_completa} e \ref{fig:arquitetura_simp} apresentam o diagrama da arquitetura completa da rede. A figura \ref{fig:arquitetura_completa} mostra com precisão o conteúdo de cada camada, enquanto a figura \ref{fig:arquitetura_simp} é um diagrama simplificado mas que explicita a divisão da rede em 7 cabeçalhos distintos, um para cada caractere a ser classificado.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{images/plate_ocr_architecture_v2.png}
\caption{Diagrama simplificado da rede de extração e classificação simultânea}
\label{fig:arquitetura_simp}
\end{figure}
